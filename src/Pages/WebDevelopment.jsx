      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16 md:mb-24">
          <motion.h1 
            ...
            className="text-4xl md:text-5xl lg:text-7xl font-black text-[#09090F] mb-8"
          >
            Build Websites That <br /><span className="text-[#9255CE]">Drive Growth</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Services Grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-24 md:mb-32">
          {serviceCards.map((service, index) => (
            <motion.div 
              ...
              className="p-8 md:p-10 bg-gray-50 rounded-[2rem] md:rounded-[2.5rem] border border-gray-100 hover:bg-white hover:shadow-2xl hover:border-transparent transition-all group"
            >
              <div className="mb-6 md:mb-8 transform group-hover:scale-110 group-hover:rotate-3 transition-transform">
                {service.icon}
              </div>
        ...
        <div className="bg-[#09090F] rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-24 text-white mb-24 md:mb-32 relative overflow-hidden">
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              <div className="inline-block bg-purple-600 px-5 md:px-6 py-2 rounded-full text-xs md:text-sm font-bold uppercase tracking-widest mb-6 md:mb-8">
                Global Reach
              </div>
              <h2 className="text-3xl md:text-4xl lg:text-6xl font-black mb-6 md:mb-8 leading-tight">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                {['RTL Support', 'Auto-Translation', 'Local SEO', 'Regional Content'].map((feature) => (
                  <span key={feature} className="px-4 md:px-5 py-2 md:py-3 bg-white/5 rounded-xl md:rounded-2xl border border-white/10 font-bold text-xs md:text-sm">
                    {feature}
                  </span>
                ))}
              </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 relative z-10">
                <FaGlobe className="text-5xl md:text-7xl text-purple-500 mb-6 md:mb-8" />
                <h3 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6">Localized Experience</h3>
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-black mb-6 text-[#09090F]">Why Choose Biosoftech?</h2>
          <p className="text-gray-600">The technology partner you can trust for your digital success.</p>
        </div>
        <div className="grid md:grid-cols-2 gap-8">
          {whyChooseUs.map((item, index) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="flex gap-8 p-10 bg-white border border-gray-100 rounded-[3rem] hover:shadow-lg transition-all"
            >
              <div className="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center text-purple-600 shrink-0 font-black text-2xl">
                0{index + 1}
              </div>
              <div>
