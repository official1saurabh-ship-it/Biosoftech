      ...
      <section className="relative overflow-hidden bg-[#f7f7f7]">
        ...
        <div className="relative max-w-[1220px] mx-auto px-6 py-14">
          <div className="grid lg:grid-cols-[1fr_560px] gap-20 items-center">
            <div>
              <h1 className="text-[50px] md:text-[36px] md:leading-[46px] lg:text-[50px] lg:leading-[66px] font-black text-black">Best Digital Marketing Agency in Lucknow for SEO, Performance Marketing, Social Media & Website Designing</h1>
              ...
              <h2 className="mt-7 text-[38px] md:text-[28px] lg:text-[38px] font-black text-[#433d70]">Our Mission</h2>
              ...
              <div className="grid grid-cols-2 gap-7 md:gap-5 lg:gap-7">
              {services.map((item) => (
                <div key={item.title} className="group bg-white rounded-[18px] p-8 md:p-6 lg:p-8 shadow-[0_18px_40px_rgba(0,0,0,.05)] hover:bg-[#3B3663] hover:-translate-y-2 duration-500">
      ...
      <section className="relative overflow-hidden bg-black">
        ...
        <div className="relative max-w-[1180px] mx-auto px-8 py-12">
          <div className="grid lg:grid-cols-[1fr_420px] gap-24 items-center">
            <div>
              <h2 className="text-[62px] md:text-[40px] md:leading-[50px] lg:text-[62px] lg:leading-[72px] font-light text-white"><span className="text-[#f2ab00] font-medium">RankON Technologies’s</span><br />Existence Is Built On<br />Conviction</h2>
              <div className="mt-8 space-y-8 text-white text-[18px] leading-[40px] md:leading-[32px] lg:leading-[40px]">
        ...
        <div className="max-w-[1350px] mx-auto px-6">
          <div className="grid lg:grid-cols-[620px_1fr] gap-24 items-center">
            ...
            >
              ...
              <h1 className="mt-2 text-[64px] md:text-[40px] md:leading-[48px] lg:text-[64px] lg:leading-[72px] font-black">
                We Transform<br />
                <span
                ...
                {[
                  ...
                  return (
                    <div key={i} className="flex gap-6 items-center">
                      ...
                      <div>
                        <h3 className="text-[32px] md:text-[24px] lg:text-[32px] font-black leading-tight">{item.title}</h3>
